...
QProgressBar#taskProgressBar::chunk { background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:1, stop:0 #22c55e, stop:1 #14b8a6); border-radius: 10px; }
...
QLabel#statusLabel[statusState='approved'] { color: #166534; font-weight: 700; }
QLabel#statusLabel[statusState='rejected'] { color: #b91c1c; font-weight: 700; }
QLabel#statusLabel[statusState='pending'] { color: #64748b; font-weight: 500; }
