...
_APPLICATION_STYLESHEET_TEMPLATE = Template(
    """
QWidget { font-family: 'Manrope', 'Segoe UI', 'Helvetica Neue', Arial, sans-serif; font-size: 14px; color: #0b1226; }
QMainWindow { background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:1, stop:0 #eef3fb, stop:1 #f7f9ff); }
#navPanel { background: qlineargradient(spread:pad, x1:0, y1:0, x2:0, y2:1, stop:0 #0b1428, stop:1 #111f3a); color: #e2e8f0; border-right: 1px solid rgba(148, 163, 184, 0.12); border-top-right-radius: 22px; border-bottom-right-radius: 22px; }
...
#navTree::item:selected { background-color: rgba(56, 189, 248, 0.3); color: #f8fafc; font-weight: 600; }
#navTree::item:hover { background-color: rgba(56, 189, 248, 0.18); }
QPushButton { background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:1, stop:0 #2563eb, stop:1 #1d4ed8); color: #f8fafc; border-radius: 12px; padding: 10px 20px; font-weight: 600; letter-spacing: 0.2px; }
...
#card { background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:1, stop:0 #ffffff, stop:1 #f6f8ff); border-radius: 22px; border: 1px solid rgba(148, 163, 184, 0.28); }
#cardTitle { font-size: 20px; font-weight: 700; color: #0b1226; letter-spacing: 0.2px; }
#cardSubtitle { color: #475569; font-size: 13px; line-height: 1.5; }
#taskProgressDialog { background-color: rgba(8, 15, 30, 0.96); border-radius: 28px; }
...
QProgressBar#taskProgressBar { background-color: rgba(15, 23, 42, 0.6); border: none; border-radius: 12px; height: 18px; padding: 4px 10px; color: #f8fafc; font-weight: 700; letter-spacing: 0.4px; }
...
#analysisSectionTitle { font-size: 16px; font-weight: 700; color: #0b1226; letter-spacing: 0.2px; border-bottom: 2px solid rgba(14, 116, 144, 0.35); padding-bottom: 6px; }
#analysisSectionTitle[tightSpacing="true"] { padding-bottom: 0px; margin-bottom: 0px; }
#pageTitle { font-size: 30px; font-weight: 800; color: #0b1226; letter-spacing: 0.6px; }
...
#emptyState { background-color: rgba(148, 163, 184, 0.12); border-radius: 18px; border: 1px dashed rgba(100, 116, 139, 0.5); }
...
QTableWidget::item:selected { background-color: rgba(14, 116, 144, 0.2); color: #0b1226; }
QHeaderView::section { background-color: rgba(148, 163, 184, 0.14); border: none; font-weight: 700; color: #0b1226; padding: 10px 6px; text-transform: uppercase; letter-spacing: 0.8px; }
QHeaderView::section:horizontal { border-bottom: 2px solid rgba(14, 116, 144, 0.35); }
QListWidget#checklist { border: none; }
QListWidget#checklist::item { padding: 12px 16px; margin: 6px 0; border-radius: 12px; }
QListWidget#checklist::item:selected { background-color: rgba(14, 116, 144, 0.16); color: #0b1226; font-weight: 600; }
...
#statValue { font-size: 26px; font-weight: 700; color: #0b1226; }
...
QComboBox, QSpinBox { background-color: #ffffff; border: 1px solid rgba(148, 163, 184, 0.5); border-radius: 12px; padding: 8px 12px; min-height: 32px; }
...
QTabWidget::pane { border: 1px solid rgba(148, 163, 184, 0.28); border-radius: 16px; background: #f4f7ff; margin-top: 12px; padding: 12px; }
QTabWidget::tab-bar { left: 12px; }
QTabWidget#fixedAssetTabs::pane { border: none; background: transparent; margin-top: 12px; padding: 0; }
QTabBar::tab { background: rgba(148, 163, 184, 0.18); color: #0b1226; padding: 10px 20px; border-radius: 12px; margin-right: 8px; font-weight: 600; }
QTabBar::tab:selected { background: #0e7490; color: #f8fafc; }
QTabBar::tab:hover { background: rgba(14, 116, 144, 0.28); color: #0b1226; }
QTabBar::tab:!selected { border: 1px solid rgba(148, 163, 184, 0.35); }
#analysisDivider { background-color: rgba(148, 163, 184, 0.5); border-radius: 2px; margin: 4px 0; }
QLineEdit, QPlainTextEdit, QTextEdit {
    ...
    padding: 10px 12px;
    color: #0b1226;
    selection-background-color: rgba(14, 116, 144, 0.2);
    selection-color: #0b1226;
}
...
QScrollBar::handle:vertical { background: #0e7490; min-height: 24px; border-radius: 6px; }
QScrollBar::handle:vertical:hover { background: #0f5f73; }
QScrollBar::add-line:vertical, QScrollBar::sub-line:vertical { height: 0; }
QScrollBar:horizontal { background: rgba(148, 163, 184, 0.18); height: 12px; margin: 0 8px 2px 8px; border-radius: 6px; }
QScrollBar::handle:horizontal { background: #0e7490; min-width: 24px; border-radius: 6px; }
QScrollBar::handle:horizontal:hover { background: #0f5f73; }
