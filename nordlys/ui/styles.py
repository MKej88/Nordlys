...
#navPanel { background: #0b1226; color: #e2e8f0; border-right: 1px solid rgba(148, 163, 184, 0.12); border-top-right-radius: 22px; border-bottom-right-radius: 22px; }
#logoLabel { font-size: 26px; font-weight: 700; letter-spacing: 0.6px; color: #f8fafc; }
#navTree { background: transparent; border: none; color: #cbd5e1; font-size: 14px; }
...
#navTree::item:selected { background-color: #1e3a8a; color: #f8fafc; font-weight: 600; }
#navTree::item:hover { background-color: rgba(30, 58, 138, 0.45); }
QPushButton { background-color: #1d4ed8; color: #f8fafc; border-radius: 10px; padding: 10px 20px; font-weight: 600; letter-spacing: 0.2px; }
QPushButton:focus { outline: none; }
QPushButton:disabled { background-color: #94a3b8; color: #e5e7eb; }
QPushButton:hover:!disabled { background-color: #163fa4; }
QPushButton:pressed { background-color: #102c6d; }
QPushButton#approveButton { background-color: #15803d; }
QPushButton#approveButton:hover:!disabled { background-color: #166534; }
QPushButton#approveButton:pressed { background-color: #0f3e1f; }
QPushButton#rejectButton { background-color: #b91c1c; }
QPushButton#rejectButton:hover:!disabled { background-color: #991b1b; }
QPushButton#rejectButton:pressed { background-color: #701a1a; }
...
#card { background-color: #ffffff; border-radius: 20px; border: 1px solid rgba(148, 163, 184, 0.28); }
...
#taskProgressPanel { background-color: #f4f7ff; border-radius: 22px; border: 1px solid rgba(148, 163, 184, 0.28); }
...
QProgressBar#taskProgressBar::chunk { background-color: #1d4ed8; border-radius: 10px; }
...
QScrollBar::handle:vertical { background: #1d4ed8; min-height: 24px; border-radius: 6px; }
QScrollBar::handle:vertical:hover { background: #163fa4; }
QScrollBar::add-line:vertical, QScrollBar::sub-line:vertical { height: 0; }
QScrollBar:horizontal { background: rgba(148, 163, 184, 0.18); height: 12px; margin: 0 8px 2px 8px; border-radius: 6px; }
QScrollBar::handle:horizontal { background: #1d4ed8; min-width: 24px; border-radius: 6px; }
QScrollBar::handle:horizontal:hover { background: #163fa4; }
